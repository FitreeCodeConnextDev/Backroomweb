...
@section('table-section')
    <table class="table-data" id="payment-group-table">
        <thead>
            <tr>
...
@section('js-scripts')
    <script>
        if (document.getElementById("payment-group-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            const dataTable = new simpleDatatables.DataTable("#payment-group-table", {
                searchable: true,
                sortable: false
            });
        }
