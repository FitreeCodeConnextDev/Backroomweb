...
@section('title_page')
    {{ __('import.import_vendor_desc') }}
@endsection
@section('index-title')
    {{ __('import.import_vendor_desc') }}
@endsection
@section('table-section')
    <form action="{{ route('import.vendors.preview') }}" enctype="multipart/form-data" method="post">
        @csrf
...
@section('js-scripts')
    ...
    <script>
        function saveSelectedToLocalStorage() {
            ...
            localStorage.setItem('selectedVendorColumns', JSON.stringify(selectedValues));
        }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const saved = localStorage.getItem('selectedVendorColumns');
            if (saved) {
