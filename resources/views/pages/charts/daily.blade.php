...
@section('scripts')
    <script type="text/javascript">
        ...
        function getdonutChartsOptions() {
            ...
            return {
                series: [<?php echo isset($sale_terminal_daily_chart['total_amount']) && is_array($sale_terminal_daily_chart['total_amount']) ? implode(',', $sale_terminal_daily_chart['total_amount']) : '0'; ?>],
                labels: [<?php echo isset($sale_terminal_daily_chart['vendor_name']) && is_array($sale_terminal_daily_chart['vendor_name']) ? "'" . implode("','", $sale_terminal_daily_chart['vendor_name']) . "'" : "'No Data'"; ?>],
                colors: chartColors,
                chart: {
                    height: 520,
                    width: "100%",
