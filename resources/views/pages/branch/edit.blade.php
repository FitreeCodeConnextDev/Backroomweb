...
@section('form-section')
    <form action="{{ route('branch.update', $branch->branch_id) }}" id="branch_form" method="post">
        @csrf
        @method('PUT')
        <div class="grid gap-6 mb-4 grid-cols-1 lg:grid-cols-3">
            <div>
                ...
                <input type="text" id="branch_id" maxlength="6" name="branch_id" placeholder="..." class="input_text"
                    value="{{ $branch->branch_id }}" disabled readonly />
                @error('branch_id')
            ...
            <div class="py-7">
                <label class="inline-flex items-center cursor-pointer">
                    ...
                    <input type="checkbox" name="online" value="1" @if ($branch->online == 1) checked @endif
                        class="sr-only peer">
                    <div
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-2">
                    <div>
                        <input type="text" id="branch_addr1" name="branch_addr1" placeholder="..." class="input_text "
                            value="{{ $branch->branch_addr1 }}" required />
                        @error('branch_addr1')
                    ...
                    <div>
                        <input type="text" id="branch_addr2" name="branch_addr2" placeholder="..." class="input_text "
                            value="{{ $branch->branch_addr2 }}" />
                    </div>
                </div>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" id="tax_name" name="tax_name" placeholder="..." class="input_text "
                    value="{{ $branch->tax_name }}" required />
                @error('tax_name')
                    <p class="mt-2 text-sm text-red-600"><span class=" font-medium"> {{ __(__('menu.is_warning')) }} </span>
                        {{ $message }} </p>
                @enderror
            ...
            <div>
                ...
                <input type="text" id="batchno" name="batchno" placeholder="78" class="input_text"
                    value="{{ $branch->batchno }}" required />
            </div>
            <div>
            ...
            <div>
                ...
                <input type="text" id="vatrate" name="vatrate" placeholder="0.00" value="7.00"
                    class="input_text " value="{{ $branch->vatrate }}" required />
                @error('vatrate')
                    <p class="mt-2 text-sm text-red-600"><span class=" font-medium"> {{ __(__('menu.is_warning')) }} </span>
                        {{ $message }} </p>
                @enderror
