<section>
    <div class="grid grid-cols-1 gap-6 border border-gray-200 rounded-lg p-5">
        @if (Route::is('vendor-page.edit'))
            <div class="flex justify-end ">
                <button data-modal-target="vendor_user_modal" data-modal-toggle="vendor_user_modal"
    ...
    <div id="vendor_user_modal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative bg-white rounded-lg shadow-sm ">
                ...
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded border-gray-200">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="vendor_user_modal">
...
@push('scripts')
    ...
    <script type="module">
        $(document).ready(function() {
            ...
            $('#user_vendor_save').on('click', function(e) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // ปิด Modal
                        $('#vendor_user_modal').addClass('hidden');
            ...
            $('[data-modal-hide="vendor_user_modal"]').on('click', function() {
                $('#vendor_user_modal').addClass('hidden');
            });
        });
    </script>
