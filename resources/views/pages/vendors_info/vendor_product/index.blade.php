...
<main>
    <div id="vendor_producttab-content">
        <div class="hidden p-4 rounded-lg" id="vendor-product-t" role="tabpanel" aria-labelledby="vendor_producttab">
            @include('pages.vendors_info.vendor_product.product_info.index', [
                'vendor_id' => $vendor_id,
                'branch_id' => $branch_id,
                'term_id' => $term_id,
            ])
        ...
        <div class="hidden p-4 rounded-lg" id="vendor_component" role="tabpanel" aria-labelledby="vendor_component-tab">
            @include('pages.vendors_info.vendor_product.vendor_productdetail.index', [
                'vendor_id' => $vendor_id,
            ])
        </div>
        <div class="hidden p-4 rounded-lg" id="vendorproduct_promo" role="tabpanel"
            aria-labelledby="vendorproduct_promo-tab">
            @include('pages.vendors_info.vendor_product.vendorproduct_promo.index', [
                'vendor_id' => $vendor_id,
                'branch_id' => $branch_id,
            ])
        </div>
        <div class="hidden p-4 rounded-lg" id="vendorproduct_promoprint" role="tabpanel"
            ...
            @include('pages.vendors_info.vendor_product.vendorproduct_promoprint.index', [
                'vendor_id' => $vendor_id,
                'branch_id' => $branch_id,
            ])
        </div>
