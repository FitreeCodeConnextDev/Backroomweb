                    ...
                    <div class="grid gap-4 mb-4 grid-cols-1 lg:grid-cols-4">
                        ...
                        <div class="lg:py-7">
                            <div class="flex items-center mb-2">
                                <input checked id="default-radio-2" type="radio" value="1" name="groupvat"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                <label for="groupvat-2"
                                    class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                                    {{ __('vendor_product.product_groupvat_y') }} </label>
                            </div>
                            <div class="flex items-center mb-4">
                                <input id="groupvat-1" type="radio" value="0" name="groupvat"
                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                <label for="groupvat-1"
