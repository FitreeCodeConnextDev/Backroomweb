@php
    ...
    $search = request()->input('vendor_product_search', '');
    if ($branch_id == '000000') {
        ...
        $vendor_product = DB::table('vendorproduct_info')
            ...
            ->where('vendorproduct_info.activeflag', '=', 1)
            ->when(request()->input('vendor_product_search'), function ($query) {
                $search = request()->input('vendor_product_search');
                $query->where(function ($subQuery) use ($search) {
                    $subQuery
                        ->where('vendorproduct_info.product_id', 'like', '%' . $search . '%')
    ...
    <div class="grid grid-cols-1 gap-3">
        ...
        <div class="overflow-x-auto ">
            <div class="flex justify-start mb-3">
                <form method="GET">
                    <input placeholder="Search..." name="vendor_product_search" value="{{ $search }}"
...
@include('pages.vendors_info.vendor_product.product_info.modal_create')
@push('scripts')
    <script type="module">
