                ...
                <div class="w-full h-auto">
                    ...
                    <section class="mt-4">
                        ...
                        <input type="number" id="cur_discount" name="cur_discount" class="input_text"
                            value="{{ $promo_dis->cur_discount }}" @if (Route::is('vendor-page.show')) disabled @endif>
                    </section>
                    <section class="mt-4">
                        ...
                        <input type="number" id="def_discount" name="def_discount" class="input_text"
                            value="{{ $promo_dis->def_discount }}" @if (Route::is('vendor-page.show')) disabled @endif>
                    </section>
                    <section class="mt-4">
                        ...
                        <input type="number" id="use_discount" name="use_discount" class="input_text"
                            value="{{ $promo_dis->use_discount }}" @if (Route::is('vendor-page.show')) disabled @endif>
                    </section>
