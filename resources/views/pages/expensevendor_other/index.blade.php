...
@section('form-section')
    <form action="{{ route('expensevendor_other_store') }}" id="expense_vendor" method="post">
        @csrf
        <div class="grid_page">
            <div class=" grid grid-cols-2 gap-2 space-x-3 p-3">
                <div>
    ...
    <section class="border-gray-400 border-t py-3">
        <div class="tab_div">
            <ul class="tab_ul-2" id="default-tab" data-tabs-toggle="#expensevendor_other_tab" role="tablist">
                <li class="me-2" role="presentation">
                    <button class="inline-block p-4 border-b-2 rounded-t-base" id="expensevendor_other_tabs"
                        data-tabs-target="#expensevendor_other" type="button" role="tab"
                        aria-controls="expensevendor_other"
                        aria-selected="false">{{ __('expense_vendor.expense_table_title') }}</button>
                </li>
            </ul>
        </div>
        <div id="expensevendor_other_tab">
            <div class="hidden p-4 rounded-base bg-neutral-secondary-soft" id="expensevendor_other" role="tabpanel"
                aria-labelledby="expensevendor_other_tabs">
