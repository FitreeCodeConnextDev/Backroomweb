...
@section('table-section')
    <table id="product-unit-table" class="table-data">
        <thead>
            <tr>
                <th scope="col">
...
@section('js-scripts')
    <script>
        if (document.getElementById("product-unit-table") && typeof simpleDatatables.DataTable !== 'undefined') {
            const dataTable = new simpleDatatables.DataTable("#product-unit-table", {
                searchable: true,
                sortable: false
            });
        }
