...
@section('table-section')
    <div class="mb-4">
        ...
        {{-- <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-200">{{ __('report.rpt_sum_daily') }}</h2> --}}
        ...
        <div class=" max-w-screen-xl mt-5">
            <form action="{{ route('gen_rpt_sum_daily') }}" method="post" target="_blank">
                @csrf
