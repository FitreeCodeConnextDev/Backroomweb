...
<div class="grid lg:grid-cols-3 grid-cols-1 gap-3">
    <div class=" mt-3 border border-gray-200 rounded-lg p-5">
        ...
        <form action="" id="vendor_rabbit_f" method="post">
            @csrf
            @method('PUT')
            <div>
                <div class=" mt-4 grid grid-col grid-cols-2 gap-2">
                    <div>
                        ...
                        <input type="date" name="start_date" class="input_text" disabled
                            value="{{ $vendor_rabbit && strtotime($vendor_rabbit->start_date) ? date('Y-m-d', strtotime($vendor_rabbit->start_date)) : '' }}">
                    </div>
                    <div>
                        <label for="" class="label_input"> {{ __('vendor.valid_date') }} </label>
                        <input type="date" name="valid_date" class="input_text" disabled
                            value="{{ $vendor_rabbit && strtotime($vendor_rabbit->valid_date) ? date('Y-m-d', strtotime($vendor_rabbit->valid_date)) : '' }}">
                    </div>
                    <section>
                        ...
                        <div class="relative">
                            ...
                            <input type="time" id="start_time" name="start_time" class="input_text" disabled
                                value="{{ $vendor_rabbit && strtotime($vendor_rabbit->start_date) ? date('H:i', strtotime($vendor_rabbit->start_date)) : '' }}" />
                        </div>
                    </section>
                    <section>
                        ...
                        <div class="relative">
                            ...
                            <input type="time" id="valid_time" name="valid_time" class="input_text" disabled
                                value="{{ $vendor_rabbit && strtotime($vendor_rabbit->valid_date) ? date('H:i', strtotime($vendor_rabbit->valid_date)) : '' }}" />
                        </div>
                    </section>
                </div>
                <div class=" grid grid-flow-col grid-rows-4 gap-2">
                    <section class="mt-2">
                        ...
                        <input id="monday" type="checkbox" name="monday" value="1" disabled
                    ...
                    <section class="mt-2">
                        ...
                        <input id="tuesday" type="checkbox" name="tuesday" value="1" disabled
                    ...
                    <section class="mt-2">
                        ...
                        <input id="wednesday" type="checkbox" name="wednesday" value="1" disabled
                    ...
                    <section class="mt-2">
                        ...
                        <input id="thursday" type="checkbox" name="thursday" value="1" disabled
                    ...
                    <section class="mt-2">
                        ...
                        <input id="friday" type="checkbox" name="friday" value="1" disabled
                    ...
                    <section class="mt-2">
                        ...
                        <input id="saturday" type="checkbox" name="saturday" value="1" disabled
                    ...
                    <section class="mt-2">
                        ...
                        <input id="sunday" type="checkbox" name="sunday" value="1" disabled
                ...
                <div class="mt-6">
                    ...
                    <input type="text" class="input_text" name="amount_use" id="amount_use" disabled
                        value="{{ $vendor_rabbit->amount_use ?? '' }}">
                </div>
                <div class="mt-6">
                    <label for="product_id" class="label_input"> {{ __('vendor.product_id') }} </label>
                    <select class="input_text" name="product_id" id="product_id" disabled>
                        <option value="" selected> {{ __('vendor.select_product') }} </option>
                        @foreach ($product_info as $product)
                            <option value="{{ $product->product_id }}"
                                @if (isset($vendor_rabbit->product_id) && $vendor_rabbit->product_id == $product->product_id) selected @endif>
