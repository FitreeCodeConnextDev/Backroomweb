...
<div class="grid grid-cols-1 lg:grid-cols-4 gap-3">
    <section>
        ...
        <form action="{{ route('vendor_function_update', ['id' => $vendor_id]) }}" class="tabs_form" method="post">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 gap-6 mt-3 border border-gray-200 rounded-lg p-5">
                <section class="mt-2">
                    <input id="default-checkbox" type="hidden" name="vendor_function_1" value="0">
                    <input id="vendor_function_1" type="checkbox" name="vendor_function_1" value="1"
                ...
                <section class="mt-2">
                    ...
                    <input id="vendor_function_2" type="checkbox" name="vendor_function_2" value="1"
                ...
                <section class="mt-2">
                    ...
                    <input id="vendor_function_3" type="checkbox" name="vendor_function_3" value="1"
                ...
                <section class="mt-2 w-full lg:w-48">
                    <label for="vendor_function_4" class="label_input">{{ __('vendor.def_4') }}</label>
                    <select name="vendor_function_4" id="vendor_function_4" class="input_text">
                ...
                <section class="mt-2 w-full lg:w-48">
                    ...
                    <select name="vendor_function_5" id="vendor_function_5" class="input_text">
                        <option value=" "
                ...
                <section class="mt-2 sr-only">
                    ...
                    <input id="vendor_function_6" type="checkbox" name="vendor_function_6" value="1"
